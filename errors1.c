 ...
 * Return: 0 if there is no number in the string it must be
 * a converted otherwise -1 an error
 */
 ...
 * Return: 0 if no there is no number in the string
 * it must be a converted number otherwise
 * -1 on error
 */
...
/**
 * convert_number - The converter function is a clone of itoa
 * @num: Number
 * @base: Base
